        ...
        <div class="sidebar">
            <div class="site-width">
                ...
                <ul id="side-menu" class="sidebar-menu">
                    <li class="dropdown"><a href="#"><i class="icon-home mr-1"></i> News</a>                  
                        <ul>
                            <li><a href="news-add.php"><i class="icon-rocket"></i> Add New</a></li>
                            <li><a href="news.php"><i class="icon-layers"></i> View All</a></li>
